...
Usage:
    python build_knowledge.py                         # Incremental update
    python build_knowledge.py --rebuild               # Wipe + re-index all
    python build_knowledge.py --clear                 # Wipe all chunks
    python build_knowledge.py -d ./my_docs --verify   # Custom dir + test
    python build_knowledge.py --dry-run               # Preview changes
"""
...
class KnowledgeBuilder:
    ...
    def index_files(
        ...
        """Parse, chunk, and store files. Returns stats dict."""
